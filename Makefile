...
upgrade: $(COMMON_CONSTRAINTS_TXT)  ## update the requirements/*.txt files with the latest packages satisfying requirements/*.in
	# in case of different django version coming from common constraint pip-tools throws error.
	cp requirements/common_constraints.txt requirements/common_constraints_orig.tmp
	...
	mv requirements/common_constraints_orig.tmp requirements/common_constraints.txt
